(macher-agent-make-tool
 macher-agent-buttercup-bench-tool
 "Run buttercup-run-discover to test the project benchmarks. You must use this tool to test changes made in \
the VFS with write to workspace tools"
 :category "execution"
 :args nil
 :command-fn
